...
public class AlienContact extends Activity {
	protected void onCreate(Bundle savedInstanceState){
		...
		Button aliens = (Button)findViewById(R.id.findAliens);
		aliens.setOnClickListener(new OnClickListener(){
		...
		spockButton.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				addToAlliance("Spock");
			}
		});
		Button worfButton = (Button)findViewById(R.id.addWorf);
		worfButton.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				addToAlliance("Worf");
			}
		});
